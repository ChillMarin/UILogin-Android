        ...
        ParseUser.requestPasswordResetInBackground(edEmail.getText().toString(), new RequestPasswordResetCallback() {
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    Toast.makeText(ResetPassword.this, "Email enviado correctamente", Toast.LENGTH_LONG).show();
                } else {
                    // Something went wrong. Look at the ParseException to see what's up.
                    Toast.makeText(ResetPassword.this, "A ocurrido un error", Toast.LENGTH_LONG).show();
